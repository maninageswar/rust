...
fn main() {
    ...
    // error for the below line : 'no method named `distance_from_origin` found for struct `Point<i32>` in the current scope'
    // why? cuz distance_from_origin method is only implemented for the type f32
